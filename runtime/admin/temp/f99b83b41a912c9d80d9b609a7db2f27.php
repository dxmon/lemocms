            ...
            <div class="layui-col-md4">
                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body layui-text">
                        <div class="lemo-notice">
                            <div class="lemo-notice-title">新增微信管理，修复其他bug</div>
                            <div class="lemo-notice-extra">2019-09-20 11:06</div>
                            <div class="lemo-notice-content layui-hide">
                                新增微信管理。<br>
                                使用easywechat开发，以便更加容易进行开发<br>
                                修复其他bug。<br>
                            </div>
                        </div>
                        <div class="lemo-notice">
                            <div class="lemo-notice-title">新增会员管理，修复其他bug</div>
                            <div class="lemo-notice-extra">2019-09-4 11:06</div>
                            <div class="lemo-notice-content layui-hide">
                                新增会员管理。<br>
                                新增会员等级管理。<br>
                                修复其他bug。<br>
                        ...
                        <div class="lemo-notice">
                            <div class="lemo-notice-title">新增文章管理以及修复bug</div>
                            <div class="lemo-notice-extra">2019-08-26 14:06</div>
                            <div class="lemo-notice-content layui-hide">
                                添加文章管理。<br>
                                添加文章分类管理。<br>
                                修复其他bug。<br>
                        ...
                        <div class="lemo-notice">
                            <div class="lemo-notice-title">新增内容管理以及修复bug</div>
                            <div class="lemo-notice-extra">2019-08-17 13:06</div>
                            <div class="lemo-notice-content layui-hide">
                                添加友情链接。<br>
                                添加了广告管理。<br>
                                修复其他bug。<br>
                        ...
                        <div class="lemo-notice">
                            <div class="lemo-notice-title">集成RBAC权限管理,站点管理</div>
                            <div class="lemo-notice-extra">2019-08-11 23:06</div>
                            <div class="lemo-notice-content layui-hide">
                                界面足够简洁清爽。<br>
                                继承RBAC权限管理，无需复杂操作。<br>
                                支持多tab，可以打开多窗口。<br>
                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body layui-text">
                        <table class="layui-table">
                            ...
                            <tr>
                                <td>主要特色</td>
                                <td>RBAC管理 内容管理 微信管理 站点配置 内容管理，会员管理 /零门槛 / 响应式 / 清爽 / 极简</td>
                            </tr>
                            <tr>
                                <td>Gitee</td>
                            ...
                            <tr>
                                ...
                                <td style="padding-bottom: 0;">
                                    <div class="layui-btn-container">
                                        <iframe src="https://ghbtns.com/github-btn.html?user=yue909&repo=LEMOCMS&type=star&count=true" frameborder="0" scrolling="0" width="100px" height="20px"></iframe>
                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body layui-text layadmin-text">
                        <p>本套CMS基于最新thinkphp6,easywechat,layui2.5.5以及font-awesome-4.7.0进行实现。LEMOCMS地址：<a class="layui-btn layui-btn-xs layui-btn-danger" target="_blank" href="https://github.com/yue909/lemocms">LEMOCMS文档</a></p>
                        <p>技术交流QQ群（455018252）：<a href="https://jq.qq.com/?_wv=1027&k=5RWLxx7"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="LEMOCMS" title="LEMOCMS">（加群请备注来源：如gitee、github、官网等）</a></p>
                        <p>喜欢此后台框架的可以给我的GitHub和Gitee加个Star支持一下</p>
                        <p class="layui-red">备注：此后台框架永久开源并长期更新。您可以方便的进行二次开发。以用于企业或个人项目中</p>
                    </div>
                </div>
