<?php /*a:3:{s:45:"E:\lemocms1.0\app\admin\view\index\index.html";i:1584436534;s:47:"E:\lemocms1.0\app\admin\view\common\header.html";i:1583038741;s:47:"E:\lemocms1.0\app\admin\view\common\footer.html";i:1582960894;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="lemo-header-content">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    <a href="javascript:;" data-refresh="刷新" data-href="<?php echo url('clearData'); ?>"><i class="fa fa-refresh"></i></a>
                </li>
                <li class="layui-nav-item" lay-unselect>
                    <a href="javascript:;" data-clear="清理" data-href="<?php echo url('clearData'); ?>" class="lemo-clear"><i class="fa fa-trash-o"></i></a>
                </li>
                ...
                <li class="layui-nav-item lemo-setting">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" lemo-content-href="<?php echo url('sys.auth/adminEdit'); ?>" data-title="基本资料" data-icon="fa fa-gears">基本资料</a>
                        </dd>
                        <dd>
                            <a href="javascript:;" lemo-content-href="<?php echo url('password'); ?>" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                        </dd>
                        <dd>
...
<script src="/static/plugins/lay-config.js?v=1.0.4" charset="utf-8"></script>
<script>
    ...
    layui.use(['jquery', 'layer', 'miniAdmin'], function () {
        ...
        var options = {
            iniUrl:"<?php echo url('menus'); ?>",    // 初始化接口
